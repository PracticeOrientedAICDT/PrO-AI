...
<div id="meuCarrossel" class="carousel-auto">
  <img src="slider1.jpg" alt="Imagem 1">
  <img src="slider2.jpg" alt="Imagem 2">
  <img src="slider3.jpg" alt="Imagem 3">
</div>
...
document.addEventListener("DOMContentLoaded", () => {
  let idx = 0;
  const imgs = document.querySelectorAll('.carousel-auto img');
